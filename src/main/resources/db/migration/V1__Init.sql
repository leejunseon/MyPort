...
ALTER TABLE TBL_ASSET
    ADD CONSTRAINT FK_ASSET_USER_U_NO FOREIGN KEY (U_NO)
...
ALTER TABLE TBL_COUNTRY
    ADD CONSTRAINT FK_COUNTRY_USER_U_NO FOREIGN KEY (U_NO)
        REFERENCES TBL_USER (U_NO)
;

-- TBL_ITEM Table Create SQL
...
(
    ...
    CONSTRAINT PK_TBL_ITEM PRIMARY KEY (I_NO)
)
;
...
COMMENT ON COLUMN TBL_ITEM.I_REGDATE IS '투자종목 등록 날짜시간'
;

COMMENT ON COLUMN TBL_ITEM.I_UPDATEDATE IS '투자종목 업데이트 날짜시간'
;

CREATE UNIQUE INDEX UQ_TBL_ITEM_1
    ON TBL_ITEM(U_NO,C_NO,A_NO,I_NAME)
;

ALTER TABLE TBL_ITEM
    ADD CONSTRAINT FK_ITEM_USER_U_NO FOREIGN KEY (U_NO)
        REFERENCES TBL_USER (U_NO)
;

ALTER TABLE TBL_ITEM
    ADD CONSTRAINT FK_ITEM_COUNTRY_C_NO FOREIGN KEY (C_NO)
        REFERENCES TBL_COUNTRY (C_NO)
;

ALTER TABLE TBL_ITEM
    ADD CONSTRAINT FK_ITEM_ASSET_A_NO FOREIGN KEY (A_NO)
